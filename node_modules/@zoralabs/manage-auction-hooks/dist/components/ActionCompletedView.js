...
const simple_wallet_provider_1 = require("@zoralabs/simple-wallet-provider");
...
const ActionCompletedView = () => {
    ...
    const { currentAction, setCurrentAction } = react_1.useContext(TransactionActionContext_1.TransactionActionContext);
    const ActionTypeToMessage = react_1.useMemo(() => ({
