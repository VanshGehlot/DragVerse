...
const useEthAmountInput = ({ hasMinPrecision = true, minValue, inputProps, label, }) => {
    const [ethValue, setEthValue] = react_1.useState(minValue);
    const { getStyles, getString } = useThemeConfig_1.useThemeConfig();
    const input = (jsx_runtime_1.jsxs("label", { children: [jsx_runtime_1.jsx("span", Object.assign({}, getStyles("ethAmountLabel"), { children: label }), void 0), jsx_runtime_1.jsx("input", Object.assign({ type: "number", step: hasMinPrecision ? getString("MIN_ETH_INPUT_PRECISION") : undefined, value: ethValue || "" }, (inputProps ? inputProps : getStyles("ethInput")), { onChange: (evt) => {
                    evt.persist();
