...
exports.Theme = {
  ...
  `,
    ethAmountLabel: css_1.css `
    margin: 4px;
    display: block;
  `,
    modalInner: css_1.css `
    background: white;
    display: flex;
    flex-direction: column;
    align-items: center;
  `,
    modalHeader: css_1.css `
    font-size: 1.4em;
  `,
    modalBidActionContainer: css_1.css `
    padding-bottom: 15px;
  `,
    modalDescription: css_1.css ``,
    updateReserveContainer: css_1.css ``,
    modalSuccessMessage: css_1.css ``,
    modalLoadingPrompt: css_1.css `
    padding: 20px;
  `,
    modalBidButton: css_1.css ``,
    updateWarning: css_1.css ``,
    modalManageMissingOwnershipMessage: css_1.css `
    padding: 20px;
  `,
};
exports.Strings = {
    ...
    CANCEL_AUCTION: (jsx_runtime_1.jsxs(react_1.Fragment, { children: [jsx_runtime_1.jsx("p", { children: "Auction is active for the given reserve price." }, void 0), jsx_runtime_1.jsx("p", { children: "You can cancel this auction before the first bid" }, void 0)] }, void 0)),
