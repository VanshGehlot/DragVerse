...
const useAuctionInformation = () => {
    const { auctionId, auctionHouse } = react_1.useContext(AuctionHouseHooksContext_1.AuctionHouseHooksContext);
    const [auctionInfo, setAuctionInfo] = react_1.useState(undefined);
    react_1.useEffect(() => {
        if (auctionId) {
