...
exports.Theme = {
    modalWrapper: css_1.css ``,
    dialogOverlay: css_1.css `
    position: fixed;
    top: 0;
    right: 0;
    bottom: 0;
  ...
  `,
    ...
    overflow-x: hidden;
  `,
    walletOptionsWrapper: css_1.css `
    padding: 15px;
  `,
    walletOption: css_1.css `
    background: #dedede;
    border: 0 none;
    position: relative;
    width: 100%;
  ...
  `,
    walletOptionsList: css_1.css `
    padding: 30px;
    background: white;
  `,
    walletError: css_1.css `
    color: var(--punk-pink) !important;
    width: 100%;
    text-align: center;
  `,
    modalTitleText: css_1.css `
    margin-top: 2px;
    font-size: 1em;
  `,
  ...
  `,
    injectedIcon: css_1.css ``,
    metamaskIcon: css_1.css ``,
    walletConnectIcon: css_1.css ``,
    modalConnectWalletButtonStyle: css_1.css ``,
};
exports.Strings = {
