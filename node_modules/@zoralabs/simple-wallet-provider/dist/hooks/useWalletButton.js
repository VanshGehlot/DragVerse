...
const useWalletButton = () => {
    const { active, account, deactivate } = core_1.useWeb3React();
    const { getString } = useThemeConfig_1.useThemeConfig();
    const { openWallet } = useWalletModalState_1.useWalletModalState();
    const addressShortened = account ? address_1.shortenAddress(account) : undefined;
