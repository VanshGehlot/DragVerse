...
const WalletOptions = () => {
    var _a;
    const { deactivate, error, active, activate } = core_1.useWeb3React();
    const { getStyles } = useThemeConfig_1.useThemeConfig();
    const { closeModal, modalWalletOpen } = useWalletModalState_1.useWalletModalState();
    const { connectors, networkId } = react_1.useContext(config_1.Web3ConfigurationContext);
    react_1.useEffect(() => {
    ...
    const handleActivate = react_1.useCallback(async (connector, onError, throwErrors) => {
        var _a, _b;
    ...
    const walletOptions = react_1.useMemo(() => {
    ...
    const renderWalletOptions = react_1.useMemo(() => walletOptions.map((option, idx) => {
        ...
        return (jsx_runtime_1.jsx(WalletOption_1.WalletOption, Object.assign({ iconStylesKey: iconStyle, onClick: () => 
    ...
    console.log(error);
    return (jsx_runtime_1.jsxs("div", Object.assign({}, getStyles("walletOptionsList"), { children: [renderWalletOptions, error && (jsx_runtime_1.jsx("div", Object.assign({}, getStyles("walletError"), { children: error instanceof core_1.UnsupportedChainIdError
